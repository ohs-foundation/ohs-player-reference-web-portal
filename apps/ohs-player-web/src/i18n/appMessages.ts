...
export const appMessageOverrides = {
  ...
  kpiCustomize: 'Customize Widgets',
  kpiPickerTitle: 'Select up to {{max}} KPI indicators',
  kpiPickerLimit: 'Maximum of {{max}} widgets reached. Remove a widget to add another.',
  kpiSaved: 'Widgets updated successfully',
  ...
  email: 'Email',
  assignmentsNeedOrgs: 'Create an organisation first.',
  assignmentsNeedLocations: 'Create a location first.',
  ...
  auditColumnResourceType: 'Resource type',
  auditColumnResource: 'Resource',
  auditFilterAction: 'Action',
  auditFilterActionAll: 'All actions',
  auditFilterResourceType: 'Resource type',
  auditFilterResourceTypeHint: 'A FHIR resource type, for example Location or Practitioner',
  auditFilterAgent: 'Agent',
  auditFilterAgentHint: 'A username, or the start of one',
  auditFilterFrom: 'From',
  auditFilterTo: 'To',
  auditFilterRangeError: 'The From date is after the To date, so the date range is not applied.',
  auditRefreshing: 'Updating the audit log',
  auditEmptyTitle: 'No audit events',
  auditEmptyDescription: 'Changes made in the portal appear here.',
  ...
  auditDetailsTitle: 'Audit event',
  auditDetailsRecorded: 'Recorded',
  auditDetailsAgent: 'Agent',
  auditDetailsAgentId: 'Agent identifier',
  auditDetailsAction: 'Action',
  auditDetailsActionValue: '{{verb}} ({{code}})',
  auditDetailsEntity: 'Resource',
  auditDetailsDescription: 'Description',
  auditDetailsType: 'Event type',
  auditDetailsOutcome: 'Outcome',
  auditDetailsSource: 'Source',
  auditDetailsRaw: 'Raw AuditEvent',
  auditOutcomeSuccess: 'Success',
  auditOutcomeMinorFailure: 'Minor failure',
  auditOutcomeSeriousFailure: 'Serious failure',
  auditOutcomeMajorFailure: 'Major failure',
