...
export const appMessageOverrides = {
  ...
  locationsEdit: 'Edit',
  locationsDeactivate: 'Deactivate',
  locationsCancel: 'Cancel',
  locationDeactivated: 'Location deactivated',
  confirmDeactivateLocationTitle: 'Deactivate location',
  confirmDeactivateLocationBody:
    'This location will be marked inactive. Its children are not affected. Continue?',
  ...
  locationsChildrenCount: 'Children',
